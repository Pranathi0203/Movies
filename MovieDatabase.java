...
{
  public void movieInfo throws SQLException,ClassNotFoundEXception
 {
  try
  {
  ...
  //create a connection to the database 'Movies'
  Connection con=DriverManager.getConnection("java:mysql://localhost:3306/Movies","root","root");
